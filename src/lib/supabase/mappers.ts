...
export function scoredPageToDbRow(
  ...
  return {
    ...
    user_id: userId,
    url: page.url,
    clicks: Math.round(page.klicks),
    impressions: Math.round(page.impressionen),
    ctr: page.ctr,
    position: page.position,
    keyword_count: page.keywordCount,
    score: Math.round(page.score),
    category: page.category,
    estimated_potential: Math.round(page.estimatedPotential),
...
export function keywordToDbRow(
  ...
  return {
    ...
    user_id: userId,
    keyword: kw.keyword,
    clicks: Math.round(kw.klicks),
    impressions: Math.round(kw.impressionen),
    ctr: kw.ctr,
